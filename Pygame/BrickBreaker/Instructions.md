...
Change the colours to your favourite palette or just swap some of the colour names in the restg of the code, up to you.

### Challenge 2
Change the size of the paddle, either make the paddle change per level change or make it the same size throughout.

### Challenge 3
Change the speed and angle of the balls movement, either per level or overall.

### Challenge 4
Change the number of bricks made, either per level or overall.
